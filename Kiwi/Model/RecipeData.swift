...
struct RecipeData{
    var recipes =
    [
        Recipe(_id: "1",name: "Pizza Margherita Tradicional", category: "Pizza", description: "Uma pizza clássica e deliciosa com molho de tomate, queijo mozzarella e manjericão fresco.", image: "margherita", steps: ["Pré-aqueça o forno a 220°C.",
     ...
     "Molho de iogurte com ervas (ou seu molho favorito)","Sal e pimenta a gosto","Azeite de oliva"], difficulty: "Hard", time: "10 mins", meal: "Lanche"),
        ...
        Recipe(_id: "3",name: "Macarrão à Carbonara", category: "Massa", description: "Uma receita italiana clássica de macarrão com um delicioso molho à base de ovos, queijo parmesão e pancetta.", image: "carbonara", steps: ["Leve uma panela grande de água salgada para ferver.",
          ...
          difficulty: "Média", time: "20 mins", meal: "Jantar"),
        
        Recipe(_id: "4",name: "Sanduíche de Salmão Defumado", category: "Fast-Food", description: "Este é um sanduíche de salmão defumado com um toque de mostarda e mel, perfeito para um almoço rápido e saboroso!", image: "sanduiche-salmao", steps: ["Comece preparando o molho de mostarda e mel misturando uma colher de mostarda Dijon com duas colheres de mel. Reserve.",
          ...
          difficulty: "Média", time: "15 mins", meal: "Lanche")
