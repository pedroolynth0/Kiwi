...
struct ReceitaData{
    var receitas =
    [
        Receita(nome: "Pizza Margherita Tradicional", categoria: "Pizza", descricao: "Uma pizza clássica e deliciosa com molho de tomate, queijo mozzarella e manjericão fresco.", imagem: "margherita", etapas: ["Pré-aqueça o forno a 220°C.",
          ...
          ingredientes: ["Massa de pizza fresca", "Molho de tomate", "Queijo mozzarella ralado", "Folhas de manjericão fresco", "Azeite de oliva extra virgem", "Sal e pimenta a gosto"],
          dificuldade: "Fácil", tempo: "30 mins"),

        
        Receita(nome: "Sanduiche de Abacate", categoria: "Fast-Food", descricao:"Este sanduíche é uma explosão de sabores frescos e texturas crocantes. É perfeito para um almoço rápido e saudável ou para qualquer ocasião em que você deseja um sanduíche delicioso e nutritivo. Aproveite!" ,imagem: "sanduiche-abacate", etapas: ["Tempere os peitos de frango com sal, pimenta e um fio de azeite de oliva. Grelhe-os até que fiquem dourados e cozidos por completo. Reserve.","Enquanto o frango está na grelha, corte o abacate e o tomate em fatias finas. Lave e seque as folhas de alface.","Escolha o pão que preferir e, se desejar, toste levemente","Para montar o sanduíche, comece com uma camada de alface fresca no pão tostado.","Coloque o peito de frango grelhado por cima da alface.","Em seguida, adicione fatias de abacate e tomate.","Regue o sanduíche com o molho de iogurte com ervas (ou o molho de sua escolha) para um toque final de sabor.","Feche o sanduíche com a outra metade do pão, pressione levemente e corte ao meio."], ingredientes: ["Peitos de frango desossados e sem pele","Abacate maduro","Tomate vermelho","Alface fresca", "Pão de sua escolha (pode ser integral, ciabatta, ou outro)",
     "Molho de iogurte com ervas (ou seu molho favorito)","Sal e pimenta a gosto","Azeite de oliva"], dificuldade: "Hard", tempo: "10 mins"),
        
        Receita(nome: "Macarrão à Carbonara", categoria: "Massa", descricao: "Uma receita italiana clássica de macarrão com um delicioso molho à base de ovos, queijo parmesão e pancetta.", imagem: "carbonara", etapas: ["Leve uma panela grande de água salgada para ferver.",
          ...
          ingredientes: ["Macarrão (como espaguete ou fettuccine)", "Pancetta picada ou bacon", "Ovos", "Queijo parmesão ralado", "Azeite de oliva", "Pimenta do reino moída na hora", "Sal"],
          dificuldade: "Média", tempo: "20 mins"),
        
        Receita(nome: "Sanduíche de Salmão Defumado", categoria: "Fast-Food", descricao: "Este é um sanduíche de salmão defumado com um toque de mostarda e mel, perfeito para um almoço rápido e saboroso!", imagem: "sanduiche-salmao", etapas: ["Comece preparando o molho de mostarda e mel misturando uma colher de mostarda Dijon com duas colheres de mel. Reserve.",
          ...
          ingredientes: ["Pão de centeio","Salmão defumado","Agrião fresco","Mostarda Dijon","Mel"],
          dificuldade: "Média", tempo: "15 mins")
